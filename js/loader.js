...
(function (root) {
    ...
    var fractalitis = function() {
      if ( !fractalitis.__waiting ) {
        fractalitis.__waiting = [];
      } //if
      fractalitis.__waiting.push( arguments );
    };
    ...
    // Get the location of the fractalitis source.
    // The last script tag should be the fractalitis source
